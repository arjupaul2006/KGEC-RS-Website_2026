...
export default function Publications() {
  const publications: Publication[] = [
    {
      title: "Optimizing Deep Neural Networks for Edge Computing in Healthcare",
    ...
    {
      title: "Scalable AI Models for Real-time Robotic Vision",
      journal: "International Conference on Robotics and Automation (ICRA)",
      date: "May 2024",
      authors: "S. Mitchell, R. Smith",
      doi: "10.1016/j.robot.2024.05.001",
      type: 'Conference'
    },
    {
      title: "The Future of Ethical AI in Academic Research",
      journal: "Nature Machine Intelligence",
      date: "January 2024",
      authors: "S. Mitchell",
      doi: "10.1038/s42256-023-00789-x",
      type: 'Journal'
    }
  ];
    ...
    <section className="bg-[#1e293b] rounded-2xl p-8 md:p-12 border border-slate-700/50 shadow-xl">
      <div className="flex items-center justify-between mb-8">
        <div className="flex items-center gap-3">
          ...
          <h2 className="text-2xl font-bold text-white">Selected Publications</h2>
        </div>
        <div className="text-xs text-slate-500 font-mono">Total: {publications.length}</div>
      </div>
